...
var navbar_partial = fs.readFileSync('templates/partials/navbar.html', {encoding: 'utf-8'});
var sidebar_partial = fs.readFileSync('templates/partials/sidebar.html', {encoding: 'utf-8'});
Handlebars.registerPartial('header', header_partial);
Handlebars.registerPartial('footer', footer_partial);
Handlebars.registerPartial('navbar', navbar_partial);
Handlebars.registerPartial('sidebar', sidebar_partial);
